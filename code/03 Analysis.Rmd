...
#### Standard
```{r reg1tables}
tab_model(reg1Z,reg2Z,reg3Z,reg4Z,reg5Z,reg6Z, p.style = "stars", show.ci = F,
...
#### Weighted
```{r reg1tablesw}
tab_model(reg1wZ,reg2wZ,reg3wZ,reg4wZ,reg5wZ,reg6wZ, p.style = "stars", show.ci = F,
          pred.labels = c("(Intercept)",
                          "Age of Social Security",
                          "Social Spending",
                          "Former Communist"),
