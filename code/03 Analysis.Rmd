...
```{r f6a}
agg_png(filename = here::here("results", "Fig6a.png"), res = 144, height = 400, width = 400)
...
knitr::include_graphics(here::here("results", "Fig6a.png"))

```

```{r f6b}
agg_png(filename = here::here("results", "Fig6b.png"), res = 144, height = 315, width = 550)
...
knitr::include_graphics(here::here("results", "Fig6b.png"))
```
### Regression Tables
